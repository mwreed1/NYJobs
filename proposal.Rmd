...
This data-set contains data from jobs listing around NYC, and is collected from 
the City of New York's official jobs website. Various features about jobs is 
provided, including "Business title", `Agency`, `number of positions`, `level`, 
`job category`, `Full time/Part time`, `Salary Range from`， `Salary Range to`, 
`Title Code Number` and so on. 
