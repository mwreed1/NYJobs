...
We chose to use this data set because it had several variables that we could explore the relationship between and because the data was easily downloadable in a form that could be imported directly into R with little pre-processing. 
